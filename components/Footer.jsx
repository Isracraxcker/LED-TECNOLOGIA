...
const Footer = () => {
  ...
  const TikTokIcon = () => (
    ...
    >
      <path
        d="M16.5 3C16.8 4.7 18.3 6.2 20 6.5V9C18.7 9 17.5 8.6 16.5 7.9V14.5C16.5 18 13.9 21 10.5 21C7.1 21 4.5 18 4.5 14.5C4.5 11 7.1 8 10.5 8C10.8 8 11.1 8 11.4 8.1V11C11.1 10.9 10.8 10.9 10.5 10.9C8.7 10.9 7.2 12.4 7.2 14.5C7.2 16.6 8.7 18.1 10.5 18.1C12.3 18.1 13.8 16.6 13.8 14.5V3H16.5Z"
        stroke="#90A1B9"
        strokeWidth="1.5"
        strokeLinecap="round"
        strokeLinejoin="round"
  ...
  const linkSections = [
    {
      title: "PRODUCTOS",
      links: [
        { text: "Starlink", path: "/shop", icon: null },
        { text: "Celulares", path: "/shop", icon: null },
    ...
    },
    {
      ...
      links: [
        ...
        { text: "Tienda", path: "/shop", icon: null },
  ...
  const socialIcons = [
    { icon: FacebookIcon, link: "https://www.facebook.com/ledtechnologystore" },
    {
      icon: InstagramIcon,
      link: "https://www.instagram.com/led_technologystore/",
    },

    { icon: TikTokIcon, link: "https://www.tiktok.com/@ledtechnologystore" },
  ];
    ...
    <footer className="mx-6 bg-white">
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col md:flex-row items-start justify-between gap-10 py-10 border-b border-slate-500/30 text-slate-500">
          <div>
            ...
            <p className="max-w-102.5 mt-6 text-sm">
              ...
              innovación, todo en un mismo lugar.
            </p>
        ...
        <p className="py-4 text-sm text-slate-500">
          Copyright 2026 © LED Tecnologia All Right Reserved.
        </p>
      </div>
    </footer>
  );
