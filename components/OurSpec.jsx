  ...
  return (
    <div className="px-6 my-20 max-w-6xl mx-auto">
      <Title
        ...
        description="Ofrecemos un servicio de primera categoría y la máxima comodidad para garantizar que su experiencia de compra sea fluida, segura y completamente libre de complicaciones."
      />
